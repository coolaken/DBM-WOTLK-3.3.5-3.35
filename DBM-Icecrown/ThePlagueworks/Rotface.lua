...
local timerSlimeSpray			= mod:NewNextTimer(21, 69508, nil, nil, nil, 2)
local timerMutatedInfection		= mod:NewTargetTimer(12, 71224, nil, nil, nil, 3, nil, DBM_CORE_L.DISEASE_ICON)
...
mod:AddBoolOption("TankArrow", "-Tank")

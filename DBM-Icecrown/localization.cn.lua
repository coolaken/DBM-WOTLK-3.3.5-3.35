...
L:SetWarningLocalization{
	...
	SpecWarnVengefulShade		= "你被复仇的暗影盯上了 - 快跑开"
}
...
L:SetOptionLocalization{
	...
	TimerAdds			= "为新的小怪显示计时",
	SpecWarnVengefulShade		= "当你被复仇的暗影盯上时显示特别警告",
	ShieldHealthFrame		= "为$spell:70842显示首领血量框架",
	WarnTouchInsignificance		= DBM_CORE_L.AUTO_ANNOUNCE_OPTIONS.spell:format(71204, GetSpellInfo(71204) or "unknown"),	
...
L:SetOptionLocalization{
	SoundWOP = "为重要技能播放额外的警告语音",
	WarnBattleFury			= DBM_CORE_L.AUTO_ANNOUNCE_OPTIONS.spell:format(69638, GetSpellInfo(69638) or "战斗之怒"),
...
L:SetMiscLocalization{
	...
	AddsAlliance			= "劫夺者，士官们，攻击!",
	AddsHorde			= "将士们，给我进攻！",
	MageAlliance	= "船体受到伤害，找个战斗法师来，搞定那些火炮!",
...
L:SetMiscLocalization{
	RunePower			= "鲜血能量",
	--PullAlliance			= "每个你杀死的部落士兵 -- 每条死去的联盟狗，都让巫妖王的军队随之增长。此时此刻华尔琪都还在把你们倒下的同伴复活成天谴军。",
...
L:SetOptionLocalization{
	...
	RangeFrame			= "显示距离框(8码)",
	WarnGastricBloat		= DBM_CORE_L.AUTO_ANNOUNCE_OPTIONS.spell:format(72551, GetSpellInfo(72551) or "unknown"),
...
L:SetOptionLocalization{
	...
	RangeFrame			= "显示距离框(8码)",
	WarnUnstableOoze		= DBM_CORE_L.AUTO_ANNOUNCE_OPTIONS.spell:format(69558, GetSpellInfo(69558) or "unknown"),
...
L:SetOptionLocalization{
	...
	WarnMutatedPlague		= DBM_CORE_L.AUTO_ANNOUNCE_OPTIONS.spell:format(72451, GetSpellInfo(72451) or "unknown"),
...
L:SetMiscLocalization{
	...
	-- PT10 嗯，什么感觉也没有。什么？！这是哪儿来的？|| p2 0:55   延展1:11 味道像……樱桃！哦！见笑了！ p3 3:40   延展 4:21
...
L:SetOptionLocalization{
	...
	TimerOutPortal			= "为离开梦境显示计时",
	TimerBlazingSkeleton		= "为下一次灼热骷髅出现显示计时",
	TimerAbom			= "为下一次贪食的憎恶出现显示计时",
	WarnCorrosion			= DBM_CORE_L.AUTO_ANNOUNCE_OPTIONS.spell:format(70751, GetSpellInfo(70751) or "unknown")
}
...
L:SetOptionLocalization{
	...
	YellOnBeaconPlanA		= "提示$spell:70126位置,每个团可能不一样!这边设置的是{rt8}{rt5}左,{rt7}{rt4}中,{rt6}{rt3}右",
	YellOnBeaconPlanB		= "提示$spell:70126位置,每个团可能不一样!这边设置的是{rt8}{rt5}左,{rt7}{rt3}中,{rt6}{rt4}右",

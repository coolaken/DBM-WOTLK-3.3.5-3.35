...
local timerRuneofBlood		= mod:NewNextTimer(20, 72410, nil, "Tank|Healer", nil, 3, nil, DBM_CORE_L.TANK_ICON)
local timerBoilingBlood		= mod:NewNextTimer(15.5, 72441, nil, nil, nil, 3, nil, DBM_CORE_L.HEALER_ICON)
...
function mod:OnCombatStart(delay)
	...
	sndWOP:ScheduleVoice(35, "mobsoon")
...
function mod:CHAT_MSG_MONSTER_YELL(msg) --联盟是40秒 bl不知道是不是多少 有待确定

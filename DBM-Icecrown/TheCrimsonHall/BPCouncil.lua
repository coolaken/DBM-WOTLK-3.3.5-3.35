...
local timerConjureFlamesCD		= mod:NewCDTimer(20, 71718, nil, nil, nil, 3, nil, DBM_CORE_L.DEADLY_ICON)				-- every 20-30 seconds but never more often than every 20sec
local timerGlitteringSparksCD	= mod:NewCDTimer(20, 72798, nil, nil, nil, 2)				-- This is pretty nasty on heroic
local timerShockVortex			= mod:NewCDTimer(16.5, 72037, nil, nil, nil, 2)			-- Seen a range from 16,8 - 21,6
local timerKineticBombCD		= mod:NewCDTimer(18, 72053, nil, "Ranged", nil, 7)				-- Might need tweaking
local timerShadowPrison			= mod:NewBuffActiveTimer(10, 72999, nil, nil, nil, 3, nil, DBM_CORE_L.HEROIC_ICON)		-- Hard mode debuff

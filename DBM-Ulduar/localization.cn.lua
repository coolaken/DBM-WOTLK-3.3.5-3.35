...
L:SetOptionLocalization{
	SoundWOP = "为重要技能播放额外的警报语音",
	SetIconOnLightBombTarget	= "cd555",
	SetIconOnGravityBombTarget	= "cd666"
}
...
L:SetOptionLocalization{
	...
	SetIconOnOverwhelmingPower	= "cd777",
	SetIconOnStaticDisruption	= "cd888",
...
L:SetOptionLocalization{
	...
	SetIconOnGripTarget		= "cd999",
	SetIconOnEyebeamTarget		= "cd10",
...
L:SetOptionLocalization{
	...
	SetIconOnNapalm			= "cd11",
	SetIconOnPlasmaBlast	= "cd12",

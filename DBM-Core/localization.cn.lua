...
L.RANGE_CHECK_ZONE_UNSUPPORTED		= "在此區域中不支援%d碼的距離檢查。\n已支援的距離有10，11，15及28碼。"
...
L.AUTO_TIMER_OPTIONS.cdcount			= "计时条：$spell:%s 冷却时间(带计数)"
...
--boss health
DBM_CORE_BOSSHEALTH_HIDE_FRAME			= "关闭血量框架"
DBM_CORE_RANGECHECK_LOCK				= "锁定"

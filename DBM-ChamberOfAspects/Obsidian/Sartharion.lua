...
local warnFireWall			= mod:NewSpecialWarning("WarningFireWall", true)
...
--			DBM:PlaySoundFile("Sound\\Spells\\PVPFlagTaken.wav")
			DBM:PlaySoundFile("Interface\\AddOns\\DBM-VPYike\\firewall.ogg")
		end

...
frameHeader:SetTexture("Interface\\DialogFrame\\UI-DialogBox-Header") -- "Interface\\DialogFrame\\UI-DialogBox-Header"
...
for i = 1, math.floor(UIParent:GetHeight() / 18) do
	...
	buttonHighlight:SetTexture("Interface\\QuestFrame\\UI-QuestLogTitleHighlight") -- "Interface\\QuestFrame\\UI-QuestLogTitleHighlight"

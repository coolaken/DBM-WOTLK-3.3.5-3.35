...
function frame:DisplayButton(button, element)
	...
	if element.haschilds then
		button.toggle:SetNormalTexture(element.showSub and "Interface\\Buttons\\UI-MinusButton-UP" or "Interface\\Buttons\\UI-PlusButton-UP") -- "Interface\\Buttons\\UI-MinusButton-UP", "Interface\\Buttons\\UI-PlusButton-UP"
		button.toggle:SetPushedTexture(element.showSub and "Interface\\Buttons\\UI-MinusButton-DOWN" or "Interface\\Buttons\\UI-PlusButton-DOWN") -- "Interface\\Buttons\\UI-MinusButton-DOWN", "Interface\\Buttons\\UI-PlusButton-DOWN"
		button.toggle:Show()
	else
		button.toggle:Hide()
	end

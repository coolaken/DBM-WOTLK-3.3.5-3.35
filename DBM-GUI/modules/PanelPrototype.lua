...
function PanelPrototype:CreateColorSelect(dimension, useAlpha, alphaWidth)
	...
	colorTexture:SetTexture("Interface\\Buttons\\UI-ColorPicker-Buttons") -- "Interface\\Buttons\\UI-ColorPicker-Buttons"
	...
	if useAlpha then
		...
		colorTexture2:SetTexture("Interface\\Buttons\\UI-ColorPicker-Buttons") -- "Interface\\Buttons\\UI-ColorPicker-Buttons"
...
function PanelPrototype:CreateLine(text)
	...
	linebg:SetTexture("Interface\\Tooltips\\UI-Tooltip-Background") -- "Interface\\Tooltips\\UI-Tooltip-Background"
...
do
	...
	function PanelPrototype:CreateCheckButton(name, autoplace, textLeft, dbmvar, dbtvar, mod, modvar, globalvar, isTimer)
		...
		if textLeft then
			...
			button.myheight = mmax(20 + 12, button.myheight)
		end
		buttonText:SetText(buttonText.text)
		button.myheight = mmax(20 + 12, 25)

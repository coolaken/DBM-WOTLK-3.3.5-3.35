...
local RAID_DIFFICULTY1, RAID_DIFFICULTY2, RAID_DIFFICULTY3, RAID_DIFFICULTY4, PLAYER_DIFFICULTY1, PLAYER_DIFFICULTY2, PLAYER_DIFFICULTY3, PLAYER_DIFFICULTY6, PLAYER_DIFFICULTY_TIMEWALKER, CHALLENGE_MODE, ALL, CLOSE = RAID_DIFFICULTY1, RAID_DIFFICULTY2, RAID_DIFFICULTY3, RAID_DIFFICULTY4, PLAYER_DIFFICULTY1, PLAYER_DIFFICULTY2, PLAYER_DIFFICULTY3, PLAYER_DIFFICULTY6, PLAYER_DIFFICULTY_TIMEWALKER, CHALLENGE_MODE, ALL, CLOSE
...
function DBM_GUI:CreateBossModPanel(mod)
	...
	for i = 1, 8 do
		...
		icon:SetTexture("Interface\\TargetingFrame\\UI-RaidTargetingIcons.blp") -- "Interface\\TargetingFrame\\UI-RaidTargetingIcons.blp"
	...
	local function CreateBossModTab(addon, panel, subtab)
		...
		if not subtab then
						...
						for i = 0, 4 do
							if optionTable[i] then
								tinsert(modProfileDropdown, {
									text	= (i == 0 and charname .. " (" .. ALL.. ")") or charname .. " (".. i .. "-" .. (charTable["talent" .. i] or "") .. ")",
			...
			local function actuallyImport(importTable)
				...
				local profileID = playerLevel > 9 and DBM_UseDualProfile and (2 or 1) or 0

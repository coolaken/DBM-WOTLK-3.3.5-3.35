...
L:SetOptionLocalization{
	TimerPhase2			= "为第二阶段显示计时条",
	IsControler			= "语音播报 寒冰皇冠卫士,建议安排控制职业开启!",
...
克尔苏加德 喊道：黑暗的虚空正等着你呢！
	...
	YellPhasetwo1		= "祈祷我的慈悲吧！",
	YellPhasetwo2		= "呼出你的最后一口气！",
	YellPhasetwo3		= "你的末日临近了！",
	YellPhasetwo4		= "黑暗的虚空正等着你呢！",
	YellMobOut			= "寒冰皇冠卫士加入了战斗！",
	YellMobOute			= "A Guardian of Icecrown enter the fight!",
	YellMob				= "主人，我需要帮助！"
}

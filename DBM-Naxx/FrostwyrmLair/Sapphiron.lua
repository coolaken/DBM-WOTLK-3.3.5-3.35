...
function mod:OnSync(event)
	if event == "DeepBreath" then
		...
		sndWOP:ScheduleVoice(5.3, "findshelter")
		sndWOP:ScheduleVoice(6.3, "countthree")
		sndWOP:ScheduleVoice(7.3, "counttwo")
		sndWOP:ScheduleVoice(8.3, "countone")

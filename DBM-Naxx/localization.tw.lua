...
L:SetOptionLocalization({
	...
	SetIconOnMC			= L.AUTO_ICONS_OPTION_TEXT:format(28410),
	SetIconOnManaBomb		= L.AUTO_ICONS_OPTION_TEXT:format(27819),
	SetIconOnFrostTomb		= L.AUTO_ICONS_OPTION_TEXT:format(27808),

...
local warnHaste				= mod:NewTargetNoFilterAnnounce(66045, 2)
local warnPolymorph			= mod:NewTargetNoFilterAnnounce(66043, 1)
local warnHexOfMending		= mod:NewTargetNoFilterAnnounce(67534, 1)
